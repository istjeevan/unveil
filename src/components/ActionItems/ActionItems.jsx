                                ...
                                <div class="inline-flex items-center">
                                    <label class="flex items-center cursor-pointer relative">
                                        <input
                                            ...
                                            class="peer h-4 w-4 cursor-pointer transition-all appearance-none rounded shadow-lg hover:shadow-lg-md border-2 border-purple-400 checked:bg-white checked:border-gray-400"
                                            id={item.id}
                                            onChange={() => handleCheckBoxChange(item.id)}
                                        />
                                        <span class="absolute text-gray-400 opacity-0 peer-checked:opacity-100 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
